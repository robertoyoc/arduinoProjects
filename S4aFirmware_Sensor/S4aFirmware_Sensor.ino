//NEW IN VERSION 1.JAC by RoboTRICKS
/*
Modificado para aceptar un sensor LM35 e imprimir la temperatura en el analogSensor 4.
Conexiones LM35
pin 1 = VCC
pin 2 = A4
pin 3 = GND
...
void calculartemperatura(){
  long miliVolts, temperatura;
  miliVolts = (analogRead(4) * 5000L) /1023;
  delayMicroseconds(10);
  temperatura= miliVolts / 10;
  ScratchBoardSensorReport(4, temperatura);
...
void sendSensorValues()
{
  ...
  for (sensorIndex = 0; sensorIndex < 4; sensorIndex++) // suprimimos la salida A5
 ...
 for (sensorIndex = 0; sensorIndex < 4; sensorIndex++)   //  Modificado para no enviar valor A5
